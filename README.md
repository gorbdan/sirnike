...
FREE_GENERATIONS_PER_DAY=0      # ежедневные бесплатные генерации (фича отключена; 0 = выкл)
...
Оплата в рублях (Telegram Payments, `currency="RUB"`). Объёмная скидка: цена за изюминку падает от мелкого пакета к крупному.

| Пакет | Изюминок | Цена (₽) | ₽ за изюминку |
|---|---|---|---|
| Проба | 10 | 90 | 9,0 |
| Фотосессия | 30 | 240 | 8,0 |
| Контент-неделя | 70 | 490 | 7,0 |
| Про | 150 | 900 | 6,0 |
| Студия | 350 | 1750 | 5,0 |
