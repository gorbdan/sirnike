...
AVATAR_REFSHEET_PROMPT = (
    "You are given MULTIPLE reference photos of the SAME single person (different angles and "
    "lighting). Study ALL of them together to capture ONLY this person's physical likeness: "
    "face shape, facial features, hairstyle and hair color, skin tone and body build. "
    "Do not rely on just one photo. "
    "CAPTURE THE PERSON, NOT THE SCENE: completely ignore and DO NOT reproduce any objects, "
    "props or items the person is holding or that appear in the reference photos — laptops, "
    "phones, bags, papers, cups, etc. In every cell the person's hands are empty and arms "
    "relaxed at the sides. Do not invent any held objects. "
    "Generate a single square image containing a clean 2x2 character reference sheet "
    "(4 equal cells, clearly separated), of this person standing against a plain light-gray "
    "studio background: "
    "Top-left: FRONT VIEW — head and upper body facing camera, neutral expression. "
    "Top-right: SIDE PROFILE — full 90° left profile. "
    "Bottom-left: THREE-QUARTER VIEW — 3/4 angle, slightly turned. "
    "Bottom-right: FULL BODY — the ENTIRE person from head to toe, standing, the whole figure "
    "(including feet) fully visible inside the cell, not cropped. "
    "CRITICAL RULES: "
    "- All four cells must depict the SAME single person — consistent identity, same face, "
    "same hairstyle, same outfit. "
    "- Keep the EXACT same person: same face shape, hair color/style, skin tone, body proportions. "
    "- Keep simple, clean clothing similar to the photos (e.g. a plain shirt), but with NO held "
    "objects and NO extra accessories beyond eyeglasses if the person wears them. "
    "- Plain light-gray or white background in every cell, nothing else in the scene. "
    "- Realistic photographic studio style — natural skin texture and lighting, "
    "no cartoon/illustration effects. "
    "- Square output (1:1 aspect ratio). High quality, detailed rendering. "
